...
void display_chooce_mode() {
	...
	settextstyle(25, 0, "幼圆", 0, 0, 1000, false, false, false);
	settextcolor(WHITE);
	int deltax = (chooce_UI.getwidth() - wbt) / 2, deltay = (h / 3 - hbt) / 2;
	button stage(w - chooce_UI.getwidth() + deltax, deltay, wbt, hbt, "assets\\UItemplate3_nor.png", "assets\\UItemplate3_over.png", "assets\\UItemplate3_mask.png", "闯关模式");
	button online(w - chooce_UI.getwidth() + deltax, h / 3 + deltay, wbt, hbt, "assets\\UItemplate3_nor.png", "assets\\UItemplate3_over.png", "assets\\UItemplate3_mask.png", "联机模式");
	button endless(w - chooce_UI.getwidth() + deltax, 2*h/3 + deltay, wbt, hbt, "assets\\UItemplate3_nor.png", "assets\\UItemplate3_over.png", "assets\\UItemplate3_mask.png", "无尽模式");

	while (1) {
		back.act_over_mask();
		stage.act_over_mask();
		online.act_over_mask();
